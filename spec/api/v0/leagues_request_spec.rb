...
RSpec.describe 'Leagues Requests' do
  describe 'Create a new league' do
    describe 'Happy Path' do
      it 'can create a league and associated user league' do
  ...
  describe 'Send all leagues' do
    ...
    describe 'Sad Path' do
      it 'returns an error if user does not exist' do
        get "/api/v0/users/1234567890/leagues"
  ...
  describe 'Send a single league' do
    ...
    describe 'Sad Path' do
      it 'returns an error if league does not exist' do
        ...
        expect(data).to be_a(Hash)
        expect(data[:errors][:detail]).to eq("Couldn't find League with 'id'=1234567890")
      end
    end
  end
  ...
  describe 'Update a league' do
    ...
    describe 'Sad Path' do
      it 'returns an error if league does not exist' do
        @updated_params = { name: "Super League", draft_time: "9:00 PM", draft_date: "2021-08-02", manager_id: 1}
        headers = { 'CONTENT_TYPE' => 'application/json' }

        patch "/api/v0/leagues/1234567890", headers: headers, params: JSON.generate(league: @updated_params)
  ...
  describe 'Delete a league' do
    ...
    describe 'Sad Path' do
      it 'returns an error if league does not exist' do
        delete "/api/v0/leagues/1234567890"
